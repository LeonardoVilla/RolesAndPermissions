...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-primary btn-sm mb-2" href="{{ route('products.index') }}"><i class="fa fa-arrow-left"></i> Voltar</a>
        </div>
    </div>
</div>
...
<form action="{{ route('products.update',$product->id) }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
          <button type="submit" class="btn btn-primary btn-sm mb-2 mt-2"><i class="fa-solid fa-floppy-disk"></i> Enviar</button>
        </div>
    </div>
</form>
